    ...
    class Unleashed1
    {
        ...
        static bool IsValid(string input)
        {
            ...
            else
            {
                ...
                {
                    string[] singerInfo = helper1[0].Split(' ', StringSplitOptions.RemoveEmptyEntries);
                    string[] venueAndPriceInfo = helper1[1].Split(' ', StringSplitOptions.RemoveEmptyEntries);
                    if (singerInfo.Length > 3 || venueAndPriceInfo.Length < 3 || venueAndPriceInfo.Length > 5)
                    {
                        return false;
                    }
                    else
