...
namespace Lists
{
    class ListsOperations
    {
        static void Main(string[] args)
        {
            ...
            helpList.Sort();
            Console.WriteLine($"Sort => {string.Join(" | ", helpList)}");
            PrintStars();
            ...
            List<int> listFinal = listA.Union(listB).ToList();
            ...
            listFinal = listA.Concat(listB).ToList();
            Console.WriteLine($"listFinal listA => {string.Join(" | ", listA)}");
            Console.WriteLine($"listFinal listB => {string.Join(" | ", listB)}");
            ...
            listFinal = listA.Intersect(listB).ToList(); //3,4
            Console.WriteLine($"listFinal listA => {string.Join(" | ", listA)}");
            Console.WriteLine($"listFinal listB => {string.Join(" | ", listB)}");
